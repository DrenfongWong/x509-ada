...
package ber_tlv_tag_h is
   ...
   pragma Convention (C, asn_tag_class);  -- ../../c/common/ber_tlv_tag.h:12

   subtype ber_tlv_tag_t is unsigned;  -- ../../c/common/ber_tlv_tag.h:18

   function ber_tlv_tag_snprint
     (tag : ber_tlv_tag_t;
      buf : Interfaces.C.Strings.chars_ptr;
      buflen : stddef_h.size_t) return stdio_h.ssize_t;  -- ../../c/common/ber_tlv_tag.h:34
   pragma Import (C, ber_tlv_tag_snprint, "ber_tlv_tag_snprint");

   function ber_tlv_tag_fwrite (tag : ber_tlv_tag_t; arg2 : access stdio_h.FILE) return stdio_h.ssize_t;  -- ../../c/common/ber_tlv_tag.h:35
   pragma Import (C, ber_tlv_tag_fwrite, "ber_tlv_tag_fwrite");

   function ber_tlv_tag_string (tag : ber_tlv_tag_t) return Interfaces.C.Strings.chars_ptr;  -- ../../c/common/ber_tlv_tag.h:36
   pragma Import (C, ber_tlv_tag_string, "ber_tlv_tag_string");

   function ber_fetch_tag
     (bufptr : System.Address;
      size : stddef_h.size_t;
      tag_r : access ber_tlv_tag_t) return stdio_h.ssize_t;  -- ../../c/common/ber_tlv_tag.h:46
   pragma Import (C, ber_fetch_tag, "ber_fetch_tag");

   function ber_tlv_tag_serialize
     (tag : ber_tlv_tag_t;
      bufptr : System.Address;
      size : stddef_h.size_t) return stddef_h.size_t;  -- ../../c/common/ber_tlv_tag.h:54
