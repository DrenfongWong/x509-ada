...
static asn_TYPE_tag2member_t asn_MAP_RSAPrivateKey_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 0, 0, 8 }, /* version at 176 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 1, -1, 7 }, /* modulus at 177 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 2, -2, 6 }, /* publicExponent at 178 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 3, -3, 5 }, /* privateExponent at 179 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 4, -4, 4 }, /* prime1 at 180 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 5, -5, 3 }, /* prime2 at 181 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 6, -6, 2 }, /* exponent1 at 182 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 7, -7, 1 }, /* exponent2 at 183 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 8, -8, 0 }, /* coefficient at 184 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 9, 0, 0 } /* otherPrimeInfos at 185 */
};
